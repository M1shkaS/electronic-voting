            ...
            <div></div>
               ...
               <div className="wrap-info">
                  <ul>
                     ...
                     <li className='wrap-info-item'>Когда время голосования закончится, вы должны отправить  свои данные (кнопка "Отправить данные"), полученные на прошлом шаге, чтобы ваш голос был засчитан и посчитан;</li>
                  </ul>
               </div>
